...
import io.gitee.security.config.DefaultWebSecurityConfigurerAdapter;
 ...
 */
@Configuration
@ConditionalOnMissingBean(DefaultResourceWebSecurityConfigurerAdapter.class)
public class DefaultResourceWebSecurityConfigurerAdapter extends DefaultWebSecurityConfigurerAdapter {
