...
public class FeignClientEncodingProperties {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(Arrays.hashCode(this.mimeTypes), this.minRequestSize);
    }

    @Override
    public String toString() {
        return "FeignClientEncodingProperties{" + "mimeTypes=" +
                Arrays.toString(this.mimeTypes) + ", " +
                "minRequestSize=" + this.minRequestSize + "}";
    }
