...
class ClientFactoryObjectProvider<T> implements ObjectProvider<T> {
    ...
    @NonNull
    @Override
    public T getIfAvailable(@NonNull Supplier<T> defaultSupplier) throws BeansException {
    ...
    @NonNull
    @Override
    public T getIfUnique(@NonNull Supplier<T> defaultSupplier) throws BeansException {
