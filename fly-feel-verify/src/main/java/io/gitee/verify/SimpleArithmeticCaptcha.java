...
import io.gitee.verify.base.ArithmeticCaptchaAbstract;
...
public class SimpleArithmeticCaptcha extends ArithmeticCaptchaAbstract {
    ...
    public SimpleArithmeticCaptcha(int width, int height, int len, String font) throws IOException, FontFormatException {
        this(width, height, len);
        setFont(font, 32f);
    }
