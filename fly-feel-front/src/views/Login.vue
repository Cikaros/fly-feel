  ...
  <div class="login-wrap">
    <el-form class="form-wrap">
      ...
      <el-form-item prop="username">
        <el-input type="text" placeholder="请输入账户" v-model="state.username"></el-input>
      </el-form-item>
      <el-form-item prop="password">
        <el-input type="password" placeholder="请输入密码" v-model="state.password"></el-input>
      </el-form-item>
      <el-button type="primary" style="width: 100%;margin-bottom: 30px;" @click="doLogin">登录</el-button>
    </el-form>
  </div>
</template>
...
defineComponent({
  name: 'Login',
  components: {ElRow, ElCol, ElForm, ElFormItem, ElInput, ElButton},
});
</script>
...
.title {
  ...
  font-weight: bold;
  text-align: center;
  text-shadow: 1px 1px 10px #9d9d9d;
  color: #6e9fd5;
}
